...
describe('RepoService', () => {
  ...
  describe('getFilteredRepos', () => {
    it('should return getFilteredRepos response as an array of Repository objects', () => {
      ...
      jest.spyOn(service, 'getFilteredRepos').mockResolvedValue(result);

      expect(service.getFilteredRepos(10, '2022-07-01', 'ts')).resolves.toEqual(result);
    });
  });
});
